...
setup(name='GECo',
      ...
      scripts=[pj('bin', 'geco'),
               ...
               pj('bin', 'geco-postprocess-3d-pointcloud-all'),
               pj('bin', 'geco-postprocess-3d-pointcloud-box'),
               pj('bin', 'geco-postprocess-3d-pointcloud-torus'),
               pj('bin', 'geco-postprocess-rotationcurve'),
               pj('bin', 'geco-postprocess-multi-param-contactsheet'),
               pj('bin', 'geco-postprocess-rotcurves-contactsheet'),
               pj('bin', 'geco-postprocess-tanvelocity'),
               pj('bin', 'geco-postprocess-abeltransform'),
